...
java $JAVA_OPTS -cp $CLASSPATH com.sun.tools.ws.WsGen test.ProviderMaintenanceServiceStronglyTypedEjb -wsdl -verbose -r wsGenGenerated -s wsGenGenerated -d wsGenGenerated 
